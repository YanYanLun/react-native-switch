...
var MaterialSwitch = React.createClass({
  ...
  render() {
    ...
    return (
      <View style={{ padding: this.padding, position: 'relative', height: this.props.buttonRadius * 2 + 2 }}>
        <View style={{
          ...
          left: this.props.buttonRadius / 2
        }}/>
        <TouchableHighlight underlayColor='transparent' activeOpacity={1} onPress={() => { this.toggle(); } } style={{
          ...
          <Animated.View style={[{
            ...
            flexDirection: 'row',
            position: 'absolute',
            left: this.props.switchHeight / 2 > this.props.buttonRadius ? (halfPadding + this.props.buttonRadius) : (halfPadding + this.props.switchHeight / 2 - this.props.buttonRadius + this.props.buttonRadius / 2),
